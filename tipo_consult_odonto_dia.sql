-- View: rl_esus."TIPO_CONSULT_ODONTO_DIA"

DROP VIEW if exists rl_esus."TIPO_CONSULT_ODONTO_DIA";

CREATE OR REPLACE VIEW rl_esus."TIPO_CONSULT_ODONTO_DIA" AS 
 SELECT tb_dim_municipio.no_municipio,
  ...
  GROUP BY tb_dim_municipio.no_municipio, (to_char(t.dt_registro::timestamp with time zone, 'yyyy'::text) || '-'::text) || to_char(t.dt_registro::timestamp with time zone, 'MM'::text), tb_dim_tipo_consulta_odonto.ds_tipo_consulta_odonto, uu.no_unidade_saude, pp.nu_cns, pp.no_profissional, cc.nu_cbo, cc.no_cbo, uu.nu_cnes;

ALTER TABLE rl_esus."TIPO_CONSULT_ODONTO_DIA"
  OWNER TO postgres;
GRANT ALL ON TABLE rl_esus."TIPO_CONSULT_ODONTO_DIA" TO postgres;
GRANT ALL ON TABLE rl_esus."TIPO_CONSULT_ODONTO_DIA" TO pmaq;
GRANT ALL ON TABLE rl_esus."TIPO_CONSULT_ODONTO_DIA" TO relatorio;
