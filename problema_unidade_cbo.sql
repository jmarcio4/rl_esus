-- View: rl_esus."PROBLEMA_UNIDADE_CBO"

DROP VIEW if exists rl_esus."PROBLEMA_UNIDADE_CBO";

CREATE OR REPLACE VIEW rl_esus."PROBLEMA_UNIDADE_CBO" AS 
...
ALTER TABLE rl_esus."PROBLEMA_UNIDADE_CBO"
  OWNER TO postgres;
GRANT ALL ON TABLE rl_esus."PROBLEMA_UNIDADE_CBO" TO postgres;
GRANT ALL ON TABLE rl_esus."PROBLEMA_UNIDADE_CBO" TO pmaq;
GRANT ALL ON TABLE rl_esus."PROBLEMA_UNIDADE_CBO" TO relatorio;
