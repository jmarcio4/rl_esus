-- View: rl_esus."PROCED_ODONTO_MES"

DROP VIEW if exists rl_esus."PROCED_ODONTO_MES";

CREATE OR REPLACE VIEW rl_esus."PROCED_ODONTO_MES" AS 
...
ALTER TABLE rl_esus."PROCED_ODONTO_MES"
  OWNER TO postgres;
GRANT ALL ON TABLE rl_esus."PROCED_ODONTO_MES" TO postgres;
GRANT ALL ON TABLE rl_esus."PROCED_ODONTO_MES" TO pmaq;
GRANT ALL ON TABLE rl_esus."PROCED_ODONTO_MES" TO relatorio;
