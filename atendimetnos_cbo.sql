-- View: rl_esus."ATENDIMENTO_CBO"

DROP VIEW if exists rl_esus."ATENDIMENTO_CBO";

CREATE OR REPLACE VIEW rl_esus."ATENDIMENTO_CBO" AS 
...
ALTER TABLE rl_esus."ATENDIMENTO_CBO"
  OWNER TO postgres;
GRANT ALL ON TABLE rl_esus."ATENDIMENTO_CBO" TO postgres;
GRANT ALL ON TABLE rl_esus."ATENDIMENTO_CBO" TO pmaq;
GRANT ALL ON TABLE rl_esus."ATENDIMENTO_CBO" TO relatorio;
